...
describe('CtaSectionComponent', () => {
  ...
  it('should render the main heading', () => {
    ...
    expect(heading?.textContent).toContain('Ready to write better, faster, and safer?')
  })

  it('should render the subheading', () => {
    const compiled = fixture.nativeElement as HTMLElement
    const subheading = compiled.querySelector('p')
    expect(subheading?.textContent).toContain('Start your AI-powered writing journey today.')
  })
